...
: IF       COMPILE-ONLY POSTPONE IF       ;
: ELSE     COMPILE-ONLY POSTPONE ELSE     ;
: THEN     COMPILE-ONLY POSTPONE THEN     ;
: CASE     COMPILE-ONLY POSTPONE CASE     ;
: ENDCASE  COMPILE-ONLY POSTPONE ENDCASE  ;
: OF       COMPILE-ONLY POSTPONE OF       ;
: ENDOF    COMPILE-ONLY POSTPONE ENDOF    ;
: BEGIN    COMPILE-ONLY POSTPONE BEGIN    ;
: AGAIN    COMPILE-ONLY POSTPONE AGAIN    ;
: UNTIL    COMPILE-ONLY POSTPONE UNTIL    ;
: WHILE    COMPILE-ONLY POSTPONE WHILE    ;
: REPEAT   COMPILE-ONLY POSTPONE REPEAT   ;
: DO       COMPILE-ONLY POSTPONE DO       ;
: ?DO      COMPILE-ONLY POSTPONE ?DO      ;
: LOOP     COMPILE-ONLY POSTPONE LOOP     ;
: +LOOP    COMPILE-ONLY POSTPONE +LOOP    ;
: LEAVE    COMPILE-ONLY POSTPONE LEAVE    ;
: UNLOOP   COMPILE-ONLY POSTPONE UNLOOP   ;
: POSTPONE COMPILE-ONLY POSTPONE POSTPONE ;
: LITERAL  COMPILE-ONLY POSTPONE LITERAL  ;
: [']      COMPILE-ONLY POSTPONE [']      ;
: [CHAR]   COMPILE-ONLY POSTPONE [CHAR]   ;
